...
// BillController.java
    ...
    @PostMapping("/account")
    public ResponseObject<?> createOnline(@RequestBody CreateBillAccountOnlineRequest request)  {
        return ResponseObject.success(billService.createBillAccountOnlineRequest(request));
    }
